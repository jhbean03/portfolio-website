...
import cvPDF from '../assets/JacksonBeanCV.pdf'
...
function Navbar({theme, setTheme, setInfo}: NavbarProps) {
  ...
  return (
    <nav className="flex sticky top-[0] left-[0] z-1 items-center justify-between p-[1.5rem_3.5rem] m-[0] bg-slate-200 dark:bg-slate-800 shadow-[0_3px_5px_rgba(0,_0,_0,_0.3)]">
      <div className="font-head text-[40px] max-lg:text-[24px] font-bold text-black dark:text-slate-200">JACKSON BEAN</div>
      ...
      max-lg:transition-transform max-lg:duration-500 max-lg:ease-in`}>
        ...
        <li>
          <a href={cvPDF} target="_blank" className="duration-200 text-black dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-300 cursor-pointer"
            onClick = { () => {
              setToggleNav(!toggleNav);
            }}
          >
